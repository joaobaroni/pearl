      ...
      builder: (context, _) {
        return Scaffold(
          ...
          appBar: PearlAppBar(
            ...
            onActionPressed: () => controller.showAssetForm(context),
          ),
          body: SafeArea(
            child: Builder(
              builder: (context) {
                ...
                return _HomeDetailBody(
                  ...
                  assets: home.assets,
                  onEditHome: () => controller.showEditHomeForm(context),
                  onAddAsset: () => controller.showAssetForm(context),
                  onEditAsset: (asset) =>
                      controller.showAssetForm(context, asset: asset),
                  onDeleteAsset: (asset) =>
